...
// console.log(uniq(names, getUniq => {
//   console.log(`The new names array with all the duplicate items removed is`, getUniq)
// }))
...
// CODE HERE 
let each = (arr, cb) => {
  return arr.forEach((el, i) => cb(el, i))
  }
...
// CODE HERE
// each(names, (item, index) => console.log(`The item at index at ${item} is ${index}`))
...
console.log(getUserById(users, '16t', user => {
...
let addingFactory = (num) => (num2) => num + num2;
...
let addNumber = addingFactory(69)
